  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-heading-lg font-semibold text-text">Clientes</h1>
          <p className="text-body-sm text-text-muted">Quien pide las cotizaciones y los pedidos.</p>
        </div>
      ...
      <div className="relative max-w-xs">
        ...
        <Input placeholder="Buscar por nombre o telefono..." className="pl-9" value={search} onChange={(e) => setSearch(e.target.value)} />
      </div>

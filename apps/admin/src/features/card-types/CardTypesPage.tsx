  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-heading-lg font-semibold text-text">Tarjetas</h1>
          <p className="text-body-sm text-text-muted">Etiquetas 5x5 y tarjetas 9x12 personalizadas que se agregan al producto.</p>
        </div>
